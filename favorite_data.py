...
most_fav_url = site_url + "/topanime.php?type=favorite"
response = requests.get(most_fav_url)
response.status_code
doc = BeautifulSoup(response.text)
...
write_csv(favorite_anime, "favorite_anime.csv")
